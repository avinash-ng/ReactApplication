...
import { ContentComponent } from './DeleteComponent'
...
describe('testing <DeleteComponent /> ', () => {
    ...
    it('renders <DrawerComponent />  correctly', () => {
        ...
        const RenderComponent = mount(<DeleteComponent> </DeleteComponent>)
    ...
    it('matches snapshot', () => {
        const RenderComponent = shallow(<DeleteComponent ></DeleteComponent>)
